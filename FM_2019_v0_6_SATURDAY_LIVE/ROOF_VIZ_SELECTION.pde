...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
void roofVizSelection(PGraphics subwindow, int xxx, float dimmer) {
  ...
  case 0: ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    //blury *= 2;
    /////////////////////////////// make brighter //////////////////////////////
    pulse(index+4, col1, col2, 1*alf*dimmer); ///((0.6)+bt*alf)*dimmer);
    subwindow.beginDraw();
    subwindow.background(0);
    subwindow.blendMode(NORMAL);
    subwindow.image(blured[index+4], size.viz.x, size.viz.y);
    subwindow.noTint();
    subwindow.endDraw();
    break;
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
