...
void dividerLines() {
  ...
  rect(size.rigWidth+size.roWidth, height/2, 1, height);                          //// vertical line to show end of ro viz area
  rect(size.rigWidth+size.roWidth+size.paWidth, height/2, 1, height);           //// vertical line to show end of pa viz area
  rect(size.ro.x, size.roHeight, size.roWidth, 1);                            //// horizontal line to divide landscape rig / ro areas
  rect(size.rig.x, size.rigHeight, size.rigWidth, 1);                               //// horizontal line to divide landscape rig / ro areas
...
void toggleKeysInfo() {
  ...
  fill(50);
  if (!da.colSwap) fill(300+(60*stutter));
  text("O = color swap", x, y+60);
  fill(50);
  if (da.colFlip) fill(300+(60*stutter));
