...
void playWithYourself(float vizTm) {
  ...
  if (beatCounter%64<4) da.colorSwap(1000000*noize);  
  if (beatCounter%82>78) ro.colorSwap(1000000*noize);
  //if (beatCounter%64>61) pa.colorSwap(1000000*noize);

  ////////////////////////////////////////// COLOR FLIP ///////////////////////////////////////////////////////////////////
  for (int i = 16; i<22; i+=2) if ( beatCounter % 128 == i) da.colFlip = true;
  else da.colFlip = false;
  for (int i = 11; i<19; i+=2) if ( beatCounter % 128 == i) ro.colFlip = true;
  else ro.colFlip = false;
  for (Rig rig : rigs) rig.colorFlip(da.colFlip);

  ///////////////////////////////////////// LERP COLOUR //////////////////////////////////////////////////////////////////
  //colBeat = false;
  if (beatCounter % 18 > 15)  colorLerping(da, (1-beat)*4);
  if (beatCounter % 18 < 4)  colorLerping(pa, (1-beat)*4);

  //if (beatCounter % 32 > 27)  colorLerping(ro, (1-beat)*3);
  ////if (beatCounter % 32 > 28)  colorLerping(pa, (1-beat)*1.5);
