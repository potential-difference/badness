...
void setupSpecifics() {
  ...
  da.availableAnims = new int[] {1, 2, 3, 6, 7, 8};      // setup which anims are used on which rig here
  // da.availableAnims = String[] {"Boxes","StarMesh"...};
  ro.availableAnims = new int[] {0, 7, 8, 11, 12, 13, 14, 15, 17, 18, 19};        // setup which anims are used on which rig here - defualt is 0,1,2,3...
  pa.availableAnims = new int[] {0, 7, 8, 11, 12, 13, 14, 15, 17, 18, 19};        // setup which anims are used on which rig here - defualt is 0,1,2,3...
  te.availableAnims = new int[] {0, 19};      // setup which anims are used on which rig here

  da.availableAlphaEnvelopes = new int[] {0, 1, 2, 3, 4, 5, 6};  
  ro.availableAlphaEnvelopes = new int[] {0, 1, 2, 3, 4, 5, 6};  
  te.availableAlphaEnvelopes = new int[] {0, 1, 2, 3, 4, 5, 6};  

  da.availableFunctionEnvelopes = new int[] {0, 1, 2};  
  ro.availableFunctionEnvelopes = new int[] {0, 1, 2};  
  te.availableFunctionEnvelopes = new int[] {0, 1, 2};  

  da.availableBkgrnds = new int[] {0, 1, 10, 11, 12, 13, 14};
  ro.availableBkgrnds = new int[] {0, 1, 3, 4, 5, 8, 10};
  te.availableBkgrnds = ro.availableBkgrnds; //new int[] {0, 3, 4, 5};

  //da.availableColors = new int[] { 0, 1, 2, 3, 4, 13, 10, 11, 12, 2, 3};
  //ro.availableColors = da.availableColors; // = new int[] { 0, 1, 2, 3, 4, 13, 10, 11, 12, 2, 3};
  ...
  //da.dimmers.put(3, new Ref(cc, 34));
