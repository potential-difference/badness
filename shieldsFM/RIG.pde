enum RigType{
    Shields,Lanterns,Diamonds,MegaSeedA,MegaSeedB,MegaSeedC,TipiLeft,TipiRight,TipiCentre,OutsideRoof,OutsideGround,Cans,Strips,Seeds,Pars,Booth,Dig,UvPars // rigs
}
