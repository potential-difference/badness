...
PGraphics lockIt(int n, float func, float func1, float alph, float alph1) {
  ...
  vis[n].image(bar1, 00, bigShieldRad/2, small, bigShieldRad*1.2);
  ...
  vis[n].image(bar1, 0, bigShieldRad/2, small, bigShieldRad*1.2);
  ...
  vis[n].image(bar1, 0, y, small, medShieldRad*1.8);
