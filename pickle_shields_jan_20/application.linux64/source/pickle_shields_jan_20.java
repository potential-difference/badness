...
class ShieldsOPCGrid extends OPCGrid {
  ...
  public void eggsOPC(OPC opc, Rig rig) {
    ...
    int fc = 2 * 512;
    int slot = 64;
    opc.led(fc+(slot*7), PApplet.parseInt(eggs[1].x), PApplet.parseInt(eggs[1].y-(eggLength/2)));          
    opc.led(fc+(slot*7)+1, PApplet.parseInt(eggs[1].x), PApplet.parseInt(eggs[1].y));
    opc.led(fc+(slot*7)+2, PApplet.parseInt(eggs[1].x), PApplet.parseInt(eggs[1].y+(eggLength/2)));
    eggLength += 20;
  }
...
class OPCGrid {
  ...
  public void shieldsBoothOPC(OPC opc) {
    ...
    // dig //
    opc.led(fc+(channel*5), PApplet.parseInt(dig.x+5), PApplet.parseInt(dig.y));
    opc.led(fc+(channel*6), PApplet.parseInt(dig.x-5), PApplet.parseInt(dig.y));
  }
  /////////////////////////////////////////////////////////////////////////////////////////////////////
