...
for(Anim an : animations) {
 an.alphaEnvelopeA = an.alphaEnvelopeA.mul(new Ramp(millis(),millis()+avgmillis*1.0,0.8,0.8,0.0));
  an.alphaEnvelopeB = an.alphaEnvelopeB.mul(new Ramp(millis(),millis()+avgmillis*1.0,0.8,0.8,0.0));
}
