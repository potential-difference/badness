...
void controllerControl(color col, float alpha) {
  fill(col, 360*alpha);
  rect(grid.mirror[0].x, grid.mirror[0].y, grid.mirrorWidth-30, grid.mirrorWidth-30);
  rect(grid.mirror[3].x, grid.mirror[3].y, grid.mirrorWidth-30, grid.mirrorWidth-30);
  rect(grid.mirror[5].x, grid.mirror[5].y, grid.mirrorWidth-30, grid.mirrorWidth-30);
  rect(grid.mirror[6].x, grid.mirror[6].y, grid.mirrorWidth-30, grid.mirrorWidth-30);
}
