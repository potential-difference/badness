...
void playWithYourself(float vizTm) {
  ...
  if (colorSwapSlider > 0) {
    for (Rig rig : rigs ) rig.colorSwap(colorSwapSlider*10000000*oskP);         //// spped of  colour swap; c/flash
  }
  if (beatCounter%64<2) rigg.colorSwap(1000000*noize);  
  if (roof != null) if (beatCounter%82>80) roof.colorSwap(1000000*noize);
  if (cans != null)if (beatCounter%64>61) cans.colorSwap(1000000*noize);
  ...
  if (roof != null) roof.colorFlip(roof.colFlip);
  if (cans != null) cans.colorFlip(cans.colFlip);

  ///////////////////////////////////////// LERP COLOUR //////////////////////////////////////////////////////////////////
  if (beatCounter % 64 > 60)  colorLerping(rigg, (1-beat)*2);
  if (roof != null) if (beatCounter % 96 > 90)  colorLerping(roof, (1-beat)*1.5);
  if (cans != null) if (beatCounter % 32 > 28)  colorLerping(cans, (1-beat)*1.5);
